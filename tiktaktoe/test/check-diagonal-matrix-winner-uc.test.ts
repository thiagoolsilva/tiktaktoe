...
import {
    CheckDiagonalMatrixWinnerUC
} from "../src/model/use-cases/matrix/check-diagonal-matrix/check-diagonal-matrix-winner-uc";
import { Player }
    from "../src/cross-cutting/index";
...
test('Principal Diagonal: No user Should win the game.', () => {
    const principalDiagonal: number[][] = [
        [0, 0, 0],
        [1, 0, 0],
        [0, 0, 0]
